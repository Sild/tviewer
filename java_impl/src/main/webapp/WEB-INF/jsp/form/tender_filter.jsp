...
--%>
<form:form method="GET" id="tender_filter_form" action="${pageContext.request.contextPath}/tender/filter" modelAttribute="tender_filter">
    <div class="input-group">
        <form:input  path="number" type="text" class="form-control" placeholder="Номер" value="${TenderFilter.number}"/>
        <form:input path="member" type="text" class="form-control"  placeholder="Участник" value="${TenderFilter.member}"/>
        <form:input path="owner" id="owner_filter" type="text" class="form-control"  placeholder="Заказчик" value="${TenderFilter.owner}"/>
        ...
        <span>
        <a href="${pageContext.request.contextPath}/tender/filter?liked=true"><input type="button" value="Избранное"></a>
        </span>
    </div>
