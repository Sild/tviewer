$(function () {
    ...
    function setUpDialog(stringSelector) {
        $(stringSelector).dialog({
            ...
            close: function () {
                ...
                edit_div.find('[name=id]').val("");
                edit_div.find('[name=name]').val("");
                edit_div.find('[name=site]').val("");
                $(this).dialog("close");
            },
            buttons: [
                {
    ...
    function setUpHandlers() {
        ...
        $('.edit_platform_btn').click(function () {
            ...
            edit_div.find('[name=id]').val($.trim(id));
            edit_div.find('[name=name]').val($.trim(name));
            edit_div.find('[name=site]').val($.trim(comment));
